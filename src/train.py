...
#to the reviewers - DO NOT HAVE ACCESS TO GPU SO I REMOVED THOSE CODE LINES :(
def train_one_epoch(train_dataloader, model, optimizer, loss):
    ...
    print("Train accuracy is {}".format(100.0*correct/total))
...
def optimize(data_loaders, model, optimizer, loss, n_epochs, save_path, interactive_tracking=False, patience=5):
    ...
    #with the good one, the factor was 0.75
